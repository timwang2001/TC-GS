...
./train.sh -d bicycle -l ${exp_name}  --gpu -1 --voxel_size ${voxel_size} --update_init_factor ${update_init_factor} --appearance_dim ${appearance_dim} --ratio ${ratio}  --tri_resolution ${tri_resolution} --feat_dim ${feat_dim} & 
sleep 20s
